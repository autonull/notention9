...
export function EditorStatusBar({ editor, saveStatus }: EditorStatusBarProps) {
  ...
  return (
    <div className="flex-shrink-0 px-4 py-1 bg-gray-900 border-t border-gray-700/50 text-xs text-gray-500 flex items-center justify-between font-mono animate-fade-in">
