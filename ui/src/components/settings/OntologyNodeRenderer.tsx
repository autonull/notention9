...
import {EditIcon, FolderIcon, MergeIcon, PlusIcon, SparklesIcon, TagIcon, TrashIcon} from '../common/icons';
    ...
    return (
        <li key={node.id} className="ml-4 border-l border-gray-700 pl-4 py-2">
            <div className="flex items-center gap-2 group">
                ...
                {isEmergent ? <SparklesIcon className="w-5 h-5 text-purple-400"/> :
                ...
                <div className="mt-2">
                    ...
                    {node.attributes && Object.entries(node.attributes).map(([key, attr]) => (
                        <div key={key} className="ml-8 flex items-center gap-2 py-1 group/attr">
                            ...
                            {isEmergent && <span
                                className="text-xs text-purple-400 border border-purple-500/50 px-1 rounded">inferred</span>}
