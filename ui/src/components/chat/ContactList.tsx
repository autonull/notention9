          ...
          `}
            >
                <div className="relative">
                    ...
                    {contact.isAgent && (
                        <div
                            className="absolute -bottom-1 -right-1 bg-gray-900 rounded-full p-0.5 border border-gray-700"
                            title="AI Agent">
        ...
        <div className="h-full flex flex-col border-r border-gray-700/50 bg-gray-900/50">
            ...
            <div className="flex-grow overflow-y-auto">
                ...
                {filteredContacts.agents.length > 0 && (
                    <div>
                        <div
                            className="px-4 py-2 bg-gray-900/80 text-xs font-semibold text-gray-500 uppercase tracking-wider flex items-center gap-2 sticky top-0 backdrop-blur-sm z-10">
