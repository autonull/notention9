...
import {CpuChipIcon, CubeIcon, DownloadIcon, PlusIcon, UserGroupIcon} from "../common/icons";
        ...
        <div className="w-64 bg-gray-900 border-r border-gray-800 flex flex-col flex-shrink-0">
            ...
            <div className="flex-1 overflow-y-auto p-2 space-y-1 custom-scrollbar">
                ...
                <div className="mt-6 mb-2 px-3 flex justify-between items-center group">
                    <span
                        className="text-[10px] font-bold text-gray-500 uppercase tracking-wider group-hover:text-gray-400 transition-colors">Agents</span>
                        ...
                        return (
                            ...
                            >
                                <div className="relative mr-2 flex-shrink-0">
                                    <CpuChipIcon
                                        className={`w-5 h-5 ${agent.status === 'Typing...' ? 'text-green-400 animate-pulse' : 'text-gray-500'}`}/>
                                    {hasNotification && (
                                        <span
                                            className="absolute -top-1 -right-1 flex h-2.5 w-2.5 rounded-full bg-red-500 ring-2 ring-gray-900"></span>
                                    )}
                                </div>
