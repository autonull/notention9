...
export const PrivacyControl: React.FC<PrivacyControlProps> = ({ note, onUpdate }) => {
    ...
    const getIcon = (level: PrivacyLevel) => {
        switch (level) {
            ...
            case 'protected': return <UserGroupIcon className="w-3 h-3" />;
            case 'public': return <WorldIcon className="w-3 h-3" />;
        }
    };
        ...
        <div className="relative flex items-center">
            ...
            {pendingPrivacy && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 p-4">
                    <div className="bg-gray-800 p-4 rounded-lg shadow-xl border border-gray-700 max-w-xs w-full animate-in fade-in zoom-in-95 duration-200">
